...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String APP_URL = "WEBSITE_URL_PLACEHOLDER";
    private static final String ADMOB_BANNER_ID = "BANNER_ID_PLACEHOLDER";
    private static final String ADMOB_INTERSTITIAL_ID = "INTERSTITIAL_ID_PLACEHOLDER";
